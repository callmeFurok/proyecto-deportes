<?php
	...
	if (!empty($fechaCalifica) && $fechaCalifica!=null && $fechaCalifica!="null") {
		

		$query3="UPDATE pro_proyecto SET certificaEnvio='no' WHERE codigo='$codigoRecomendacion';";
		...
		$query="UPDATE pro_proyecto SET calificarDevuelto='si',rectificacion=NULL,califica='R',obserbaRecomiendaDir='$observacionRecomendacion',recomendacion='$referenciasDos' WHERE codigo='$codigoRecomendacion';";
	...
	$query2="INSERT INTO `ezonshar2`.`pro_observacionrecomendacion` (`idObservacionesRecomendacion`, `observacion`, `codigo`, `fecha`, `hora`, `tipo`) VALUES (NULL, '$observacionRecomendacion', '$codigoRecomendacion', '$fecha_actual', '$hora_actual','$referenciasDos');";
