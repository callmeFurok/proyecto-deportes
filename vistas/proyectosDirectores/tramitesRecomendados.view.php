...
<div class="wrapper row3">
  ...
  <div class="contenido__general">
    ...
    <div class="contenedor__tabla">
      ...
      <table id="tablaProyectosDirectoresRecomendaciones" name="tablaProyectosDirectoresRecomendaciones" class="cell-border" border="2">
          ...
          <thead> 
              ...
              <tr> 
                  ...
                  <th class="tamanio__fuente__enfasis__tablas">Monto</th>
                   <th class="tamanio__fuente__enfasis__tablas">Fecha Inicio<br>de Calificación</th>
                  <th class="tamanio__fuente__enfasis__tablas">Fecha Inicio<br>de ejecución</th>
                  <th class="tamanio__fuente__enfasis__tablas">Recomendar</th>
                  <th class="tamanio__fuente__enfasis__tablas">Documentos / Observaciones</th>
