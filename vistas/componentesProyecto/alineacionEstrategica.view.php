...
<div class="panel-body">
  ...
  <div class="row"> 
    ...
    <div class="col-sm-2 col-xs-2 text-center">
      ...
      <span class="cursores__modales" data-toggle="modal" data-target="#modalAlineacionEstrategica"><i class="fas fa-question-circle"></i><br><div class="letras__precionar">Click para obtener<br>mayor informacion</div></span>
  ...
  <div class="row" data-toggle="tooltip" title="Seleccione una línea política según lo requerido"> 
    ...
    <div class="col-sm-2 col-xs-2 text-center">
      ...
      <span class="cursores__modales" data-toggle="modal" data-target="#modalPlanDecenal"><i class="fas fa-question-circle"></i><br><div class="letras__precionar">Click para obtener<br>mayor informacion</div></span>
