...
$query="SELECT idBaseLegal FROM pro_baselegal WHERE codigoProyecto='$codigo';";
...
<div class="wrapper row3 clase__tabs">
  ...
  <?php if (empty($infrasTrusSelects) || $infrasTrusSelects==null): ?>
      ...
      <!--==============================================
      =            Si es de infraestructura            =
      ===============================================-->
      
      <div style="display:flex; position:relative; left:5%;">
      Presionar si su proyecto está orientado a infraestrcutura&nbsp;&nbsp;<input type="checkbox" id="infraestructurasSeleccionables" codigos='<?=$codigo?>'>
      </div>
      <!--====  End of Si es de infraestructura  ====-->
  ...
  <?php else: ?>
      ...
      <div style="display:flex; position:relative; left:5%;">
      Presionar si su proyecto está orientado a <span style="font-weight:bold;">Infraestructura Deportiva</span>&nbsp;&nbsp;<input type="checkbox" id="infraestructurasSeleccionables" codigos='<?=$codigo?>' checked="checked">
      </div>
      <!--====  End of Si es de infraestructura  ====-->
      ...
      <div class="tab-content responsive">
        ...
        <div role="tabpanel" class="tab-pane" id="enviarProyecto">
          ...
          <?php 
            ...
            $plantilla->componentesProyecto(12);
