...
=            Aside            =
============================-->
<?php $plantilla->componentesDasboard(5);?>
<!--====  End of Aside  ====-->
...
<div class="main-header">
  ...
  <div class="container-fluid">
    ...
    <div class="wrapper row3">
      ...
      <div class="contenido__general">
        ...
        <div class="contenedor__tabla">
          ...
          <table id="tablaProyectos" name="tablaProyectos" class="cell-border">
    ...
    <div class="modal fade" id="visualizarDocumentosPrincipalAdmin">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document" style="width:80%;">
        ...
        <div class="modal-content">
          ...
          <div class="modal-header" style="background:white!important; color:black!important;">
            ...
            <h5 class="modal-title" id="exampleModalLongTitle" style="font-weight:bold; position: relative; left:45%;">DOCUMENTOS</h5>
