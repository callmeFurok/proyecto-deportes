...
<div class="main-header">
  ...
  <div class="container-fluid">
     ...
     <table id="tablaProyectosSecretariaComiteCertifica" name="tablaProyectosSecretariaComiteCertifica" class="cell-border" border="2">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <center>
                  <input type="checkbox" name="asistenciaMinistro" id="asistenciaMinistro"  class="estilos__radios asistencias__globales asistencias__revisadas"/>
                </center>
            ...
            <tr>
              ...
              <td>
                ...
                <center>
                  <input type="checkbox" name="asistenciaSusesAlto" id="asistenciaSusesAlto" class="estilos__radios asistencias__globales asistencias__revisadas" />
                </center>
            ...
            <tr>
              ...
              <td>
                ...
                <center>
                  <input type="checkbox" name="asistenciaActividadFisica" id="asistenciaActividadFisica" class="estilos__radios asistencias__globales asistencias__revisadas" />
                </center>
            ...
            <tr>
              ...
              <td>
                ...
                <center>
                  <input type="checkbox" name="asistenciaCoordinador" id="asistenciaCoordinador" class="estilos__radios asistencias__globales asistencias__revisadas" />
                </center>
            ...
            <tr>
              ...
              <td>
                ...
                <center>
                  <input type="checkbox" name="asistenciaPlanificacion" id="asistenciaPlanificacion" class="estilos__radios asistencias__globales asistencias__revisadas" />
                </center>
            ...
            <tr>
              ...
              <td>
                ...
                <center>
                  <input type="checkbox" name="asistenciaJuridico" id="asistenciaJuridico" class="estilos__radios asistencias__globales asistencias__revisadas" />
                </center>
            ...
            <tr class="generar__inputs">
              ...
              <td>
                ...
                ===================================================-->
                <input type="text" id="firmaRedundanteProyectos" name="firmaRedundanteProyectos">
                <input type="text" id="cargoRedundanteProyectos" name="cargoRedundanteProyectos">
                <input type="text" id="nombreProyecto" name="nombreProyecto">
                <input type="text" name="notificacionDirecta" id="notificacionDirecta">
                <input type="text" name="codgioProyectoDocumentos" id="codgioProyectoDocumentos">
            ...
            <tr>
              ...
              <td class="acta__reunion__realizadas" colspan="2">

                <a id="documentoReunion" target="_blank"/>

              </td>

              <td colspan="2">
                <center><button id="generarCalificacion" name="generarCalificacion" class="anadir__cosas btn btn-primary" style="width:100%; border-radius:1em; padding:.5em;"><i class="far fa-share-square"></i>GENERAR ACTA DE CALIFICACIÓN</button></center>
                <div class="reload__documento__reunion"></div>
              </td>  
            ...
            <tr>
              ...
              <td colspan="5" align="center">
                ...
                <center>
                  <button id="envioActasFirmantesComite" name="envioActasFirmantesComite" class="anadir__cosas btn btn-primary" style="border-radius:1.5em; padding:1em;"><i class="fas fa-save"></i>&nbsp;ENVIAR ACTAS PARA FIRMAR</button>
                </center>

                <div class="reload__generar"></div>
