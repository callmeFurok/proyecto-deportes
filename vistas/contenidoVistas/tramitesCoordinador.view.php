    ...
    <div class="wrapper row3">
      ...
      <div class="contenido__general">
        ...
        <div class="contenedor__tabla">
          ...
          <table id="tablaProyectosCoordinadores" name="tablaProyectosCoordinadores" class="cell-border" border="2">
              ...
              <thead> 
                  ...
                  <tr> 
                      ...
                      <th class="tamanio__fuente__enfasis__tablas">Reasignar<br>funcionario</th>
