<?php
	...
	$query="SELECT nombreCompleto FROM pro_deportistaorganismo WHERE cedulaUsuario='$cedulaRucEnviadosDiscriminantes';";
	...
	$query2="SELECT nombreOrganismo FROM pro_federacion WHERE rucOrganismo='$cedulaRucEnviadosDiscriminantes';";
	...
	if (!empty($nombreOrganismo)) {
		...
		$query2002="SELECT callePrincipalCiudadano,numeracionCiudadao,calleSecundariaCiudadano,referenciaCiudadano,email,telCiudadano,telefono FROM pro_deportistaorganismo WHERE cedulaUsuario='$cedulaRucEnviadosDiscriminantes';";
	...
	<table class="tabla__bordada tabla__nombre__portada">
		...
		<tr>
			<td class="contenedor___nombre__proyecto__portada" align="center">
				INFORME FINAL DE<br>EJECUCIÓN DEL<br>PROGRAMA/<br>PROYECTO<br>DEPORTIVO
			</td>
		</tr>
